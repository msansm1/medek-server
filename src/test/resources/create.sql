...
-- Table `meddb`.`ALBUM`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meddb`.`ALBUM` (  `ID` INT NOT NULL AUTO_INCREMENT,  `TITLE` VARCHAR(45) NOT NULL,  `COVER` VARCHAR(45) NULL,  `RELEASEDATE` DATETIME NULL,  `GENRE` INT NULL,  `NBTRACKS` INT NULL,  `SUPPORT` INT NULL, `CDS` INT NULL,   PRIMARY KEY (`ID`),  CONSTRAINT `FK_AL_SUP_SUPPORT`    FOREIGN KEY (`SUPPORT`)    REFERENCES `meddb`.`SUPPORT` (`ID`)    ON DELETE NO ACTION    ON UPDATE NO ACTION,  CONSTRAINT `FK_AL_GENRE_GENRE`    FOREIGN KEY (`GENRE`)    REFERENCES `meddb`.`GENRE` (`ID`)    ON DELETE NO ACTION    ON UPDATE NO ACTION) ENGINE = InnoDB;
...
-- Table `meddb`.`TRACK`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meddb`.`TRACK` (  `ID` INT NOT NULL AUTO_INCREMENT,  `ALBUM` INT NOT NULL,  `TITLE` VARCHAR(45) NOT NULL, `NUMBER` INT NULL, `LENGTH` VARCHAR(45) NULL, `CD` INT NULL,   PRIMARY KEY (`ID`),  CONSTRAINT `FK_TR_ALBUM_ALBUM`    FOREIGN KEY (`ALBUM`)    REFERENCES `meddb`.`ALBUM` (`ID`)    ON DELETE NO ACTION    ON UPDATE NO ACTION) ENGINE = InnoDB;
...
-- Table `meddb`.`USER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meddb`.`USER` (  `ID` INT NOT NULL AUTO_INCREMENT,  `LOGIN` VARCHAR(20) NOT NULL,  `PASSWORD` VARCHAR(65) NOT NULL,  `EMAIL` VARCHAR(75) NOT NULL,  `TOKEN` VARCHAR(60) NULL,  `MOBILE_TOKEN` VARCHAR(60) NULL,  PRIMARY KEY (`ID`)) ENGINE = InnoDB;
