...
public class ConfigurationServiceTest {
    ...
    public void callGetList(@ArquillianResource URL url) throws Exception {
        ...
        List<JsonConfParam> response = client.target(url.toString() + svc_root).request(MediaType.APPLICATION_JSON)
                .header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN).get(List.class);
