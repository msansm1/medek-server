...
public class FriendServiceTest {
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonFriend> response = client.target(TestConstants.SERVER_ROOT + APP_NAME + svc_root + "/1")
    ...
    public void callDelete() throws Exception {
        ...
        JsonSimpleResponse response = client.target(TestConstants.SERVER_ROOT + APP_NAME + svc_root + "/1/3/delete")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
